...
<body>
  ...
  <div class="col-8 offset-2">
    <!-- <br /><br /> -->
    <h3>Edit a your Listing</h3>
    <form
      method="POST"
      action="<?= base_url('img/update/'.$editList['id']); ?>"
      novalidate
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
       ...
       <div class="mb-3">
        ...
        <input name="listing_image" type="file" class="form-control" />
    ...
    <div class="row">
      ...
      <div class="mb-3">
        ...
        <input
          ...
          placeholder="Sangamner, Maharashtra"
          type="text"
          class="form-control"
          required
        />
...
<!-- 
      ...
      <button class="btn btn-dark add-btn mt-3" name="edit">Edit</button>
    </form>
  </div>
</div>
</div>
